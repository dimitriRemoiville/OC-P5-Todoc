...
public class MainActivity extends AppCompatActivity implements TasksAdapter.DeleteTaskListener {
    ...
    /**
     * Called at the creation of the main activity to configure the ViewModel
     */
    private void configureViewModel() {
        ViewModelFactory viewModelFactory = Injection.provideViewModelFactory(this);
        mTaskViewModel = new ViewModelProvider(getViewModelStore(), viewModelFactory).get(TaskViewModel.class);

        // Observes changing in the LiveData
